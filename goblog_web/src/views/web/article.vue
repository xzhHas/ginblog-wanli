<template>
  <div class="base_view article_view">
    ...
    <div style="height: 600px">
      <GVBBanner class="gvb_article_title" :url="data.banner_url" :slogan="data.title" :abstract="data.abstract"
        is-article v-if="data.title !== ''"></GVBBanner>
    </div>
      ...
      <div class="gvb_inner_container">
        ...
        <article>
          ...
          <div class="article_content">
            <MdPreview :previewOnly="true" v-model="data.content" :theme="theme" :editorId="data.id" />
          </div>
          ...
          <div class="article_comment_to">
            ...
            <div class="body">
              <a-textarea class="article_comment_ipt" v-model:value="commentData.content"
                :auto-size="{ minRows: 6, maxRows: 6 }" @keydown.ctrl.enter="addComment"
        ...
        <aside>
          ...
          <div class="article_directory_action" ref="article_directory" :style="slideStyle">
            <div class="article_directory">
              ...
              <div class="body">
                <MdCatalog ref="articlePreview" :editorId="data.id" :scroll-element="scrollElement" :theme="theme"
